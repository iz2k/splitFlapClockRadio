...
#pragma PERSISTENT
#endif
_DECL uint16_t  mm_ir_threshold   _INIT(150);
...
#pragma PERSISTENT
#endif
_DECL uint8_t  mm_hall_digit   _INIT(12);

/* WW */
#ifdef VAR_DECLS
#pragma PERSISTENT
#endif
_DECL uint16_t  ww_ir_threshold   _INIT(500);

#ifdef VAR_DECLS
#pragma PERSISTENT
#endif
_DECL uint16_t  ww_hall_threshold   _INIT(1000);

#ifdef VAR_DECLS
#pragma PERSISTENT
#endif
_DECL uint8_t  ww_hall_digit   _INIT(0);
