...
########## PACKAGE INFO ##########
name = 'executorRepository'
description='Server Side Executor Software Respository'
version ='1.0'
author='Farsens'
...
dist_zip.write(Path('./executorRepository/res/splash.png'), arcname='res/splash.png')
dist_zip.close()
